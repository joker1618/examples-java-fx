package xxx.joker.examples.javafx.resizable;
...
public class ResizablePanes extends Application {
    ...
    public void start(Stage stage) {
        ...
        toolbar.setStyle(!toolbar.getStyle().isEmpty()?toolbar.getStyle()+";":"" + "-fx-background-color: red");
        DragResizer.makeResizable(toolbar);
        ...
        leftFlapBar.setStyle("-fx-background-color: YELLOW");
        DragResizer.makeResizable(leftFlapBar);
